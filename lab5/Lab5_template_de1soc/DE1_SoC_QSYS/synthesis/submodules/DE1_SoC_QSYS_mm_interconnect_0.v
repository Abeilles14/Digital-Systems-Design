...
// 
// Generated using ACDS version 14.1 186 at 2021.04.02.14:16:30
...
module DE1_SoC_QSYS_mm_interconnect_0 (
	...
	wire          cmd_mux_020_src_valid;                                                     // cmd_mux_020:src_valid -> lfsr_clk_interrupt_gen_s1_agent:cp_valid
	wire  [116:0] cmd_mux_020_src_data;                                                      // cmd_mux_020:src_data -> lfsr_clk_interrupt_gen_s1_agent:cp_data
	wire          cmd_mux_020_src_ready;                                                     // lfsr_clk_interrupt_gen_s1_agent:cp_ready -> cmd_mux_020:src_ready
	wire   [24:0] cmd_mux_020_src_channel;                                                   // cmd_mux_020:src_channel -> lfsr_clk_interrupt_gen_s1_agent:cp_channel
	wire          cmd_mux_020_src_startofpacket;                                             // cmd_mux_020:src_startofpacket -> lfsr_clk_interrupt_gen_s1_agent:cp_startofpacket
	wire          cmd_mux_020_src_endofpacket;                                               // cmd_mux_020:src_endofpacket -> lfsr_clk_interrupt_gen_s1_agent:cp_endofpacket
	...
	wire          lfsr_clk_interrupt_gen_s1_agent_rp_valid;                                  // lfsr_clk_interrupt_gen_s1_agent:rp_valid -> router_023:sink_valid
	wire  [116:0] lfsr_clk_interrupt_gen_s1_agent_rp_data;                                   // lfsr_clk_interrupt_gen_s1_agent:rp_data -> router_023:sink_data
	wire          lfsr_clk_interrupt_gen_s1_agent_rp_ready;                                  // router_023:sink_ready -> lfsr_clk_interrupt_gen_s1_agent:rp_ready
	wire          lfsr_clk_interrupt_gen_s1_agent_rp_startofpacket;                          // lfsr_clk_interrupt_gen_s1_agent:rp_startofpacket -> router_023:sink_startofpacket
	wire          lfsr_clk_interrupt_gen_s1_agent_rp_endofpacket;                            // lfsr_clk_interrupt_gen_s1_agent:rp_endofpacket -> router_023:sink_endofpacket
